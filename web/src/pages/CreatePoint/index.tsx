...
const CreatePoint = () => {
  ...
  useEffect(() => {
    axios.get<IGBECityResponse[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectedUf}/municipios`)
      .then(response => {
    ...
    <div id="page-create-point">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <fieldset>
          ...
          <Map center={[-23.5530399, -46.7399915]} zoom={15} onClick={handleMapClick}>
            <TileLayer
